...
var spr_orange_flame_reg = preload("res://Textures/Weapons/Flame/09.png")
var spr_orange_flame_atk = preload("res://Textures/Weapons/Flame/08.png")
...
@onready var sound_attack = $orange_flame_sound
...
func update_orange_flame():
	level = player.orangeflame_level
	match level:
		1:
			hp = 9999
			speed = 200.0
...
func enable_attack(atk = true):
	if atk:
		...
		sprite.texture = spr_orange_flame_atk
	else:
		collision.call_deferred("set","disabled",true)
		sprite.texture = spr_orange_flame_reg
